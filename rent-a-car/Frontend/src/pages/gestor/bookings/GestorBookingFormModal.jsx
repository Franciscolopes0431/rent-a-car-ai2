        ...
        <Form onSubmit={handleSubmit}>
          <Modal.Body>
            ...
            <Row className="g-3">
              ...
              <Col md={6}>
                <Form.Group controlId="gestor-pickupLocation"><Form.Label>Local de levantamento</Form.Label><Form.Select value={formData.pickupLocation} onChange={(event) => setFormData({ ...formData, pickupLocation: event.target.value })} isInvalid={!!errors.pickupLocation}><option value="Lisboa - Aeroporto">Lisboa — Aeroporto</option><option value="Porto - Aeroporto">Porto — Aeroporto</option><option value="Faro - Aeroporto">Faro — Aeroporto</option></Form.Select><Form.Control.Feedback type="invalid">{errors.pickupLocation}</Form.Control.Feedback></Form.Group>
              </Col>
              <Col md={6}>
