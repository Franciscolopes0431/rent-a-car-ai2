...
function GestorCustomerFormModal({ show, customer, onHide, onSaved }) {
    ...
    <Modal show={show} onHide={onHide} centered>
      ...
      <Form onSubmit={handleSubmit}>
        <Modal.Body>
          ...
          <Form.Group controlId="gestor-firstName" className="mb-3">
          ...
          <Form.Group controlId="gestor-lastName" className="mb-3">
          ...
          <Form.Group controlId="gestor-email" className="mb-3">
          ...
          <Form.Group controlId="gestor-phone" className="mb-3">
          ...
          <Form.Group controlId="gestorCustomerPassword" className="mb-3">
...
export default GestorCustomerFormModal;
