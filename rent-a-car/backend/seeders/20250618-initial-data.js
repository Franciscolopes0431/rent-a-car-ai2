...
module.exports = {
  async up(queryInterface) {
    ...
    const vehicles = [
      ['Peugeot', '308', 'AB-12-CD', 'Compacto', 49.00, 'Reservado'],
      ['Renault', 'Clio', 'EY-98-ZA', 'Citadino', 35.00, 'Disponível'],
      ['BMW', 'X3', 'MN-55-DP', 'SUV', 105.00, 'Disponível'],
      ['Ford', 'Focus', 'QR-77-ST', 'Compacto', 48.00, 'Manutenção'],
      ['Audi', 'A4', 'UV-33-WX', 'Berlina', 89.00, 'Disponível'],
      ['Volkswagen', 'Golf', 'HZ-22-KL', 'Compacto', 52.00, 'Disponível'],
      ['Toyota', 'Corolla', 'JP-19-QA', 'Berlina', 54.00, 'Reservado'],
      ['Nissan', 'Qashqai', 'KR-84-LM', 'SUV', 65.00, 'Disponível'],
      ['Citroën', 'C3', 'GT-07-PR', 'Citadino', 34.00, 'Disponível'],
      ['Mercedes', 'A180', 'FD-44-VT', 'Berlina', 78.00, 'Disponível'],
      ['Seat', 'Leon', 'SB-20-NE', 'Compacto', 47.00, 'Reservado'],
      ['Skoda', 'Octavia', 'OC-31-JD', 'Berlina', 58.00, 'Disponível'],
      ['Hyundai', 'Tucson', 'TH-75-UX', 'SUV', 69.00, 'Disponível'],
      ['Opel', 'Corsa', 'OP-18-CR', 'Citadino', 35.00, 'Reservado'],
      ['Kia', 'Sportage', 'KI-90-SP', 'SUV', 70.00, 'Disponível'],
      ['Volvo', 'XC40', 'VO-63-XL', 'SUV', 84.00, 'Manutenção'],
      ['Fiat', 'Panda', 'FI-11-PA', 'Citadino', 32.00, 'Disponível'],
      ['Porsche', 'Cayenne', 'PO-77-RS', 'Desportivo', 450.00, 'Reservado'],
      ['Mini', 'Cooper', 'MI-23-NI', 'Citadino', 48.00, 'Disponível'],
      ['Dacia', 'Duster', 'DA-56-ST', 'SUV', 57.00, 'Disponível'],
      ['Lexus', 'NX', 'LX-89-NX', 'SUV', 110.00, 'Reservado'],
      ['Mazda', '3', 'MZ-41-ZA', 'Berlina', 55.00, 'Disponível'],
      ['Alfa Romeo', 'Giulia', 'AL-64-GI', 'Desportivo', 125.00, 'Manutenção'],
      ['Honda', 'Jazz', 'HO-25-JZ', 'Citadino', 38.00, 'Disponível'],
    ];
